...
public class OkHttpMainActivity extends OkBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.net_main_okgo);
    ...
    public void fab(View view) {
        showToast("我的Github,欢迎star\", \"https://github.com/jeasonlzy");
    }
    ...
    private class MainAdapter extends BaseRecyclerAdapter<OkHttpModel, ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view;
            if (viewType == 0) {
                view = inflater.inflate(R.layout.net_item_main_list, parent, false);
            } else {
                view = inflater.inflate(R.layout.net_item_main_type, parent, false);
            }
