...
public class CircleSeekBar extends View {
    ...
    private void initAttrs(AttributeSet attrs, int defStyleAttr) {
        ...
        mStartAngle = a.getInt(R.styleable.CircleSeekBar_start_angle, 0);
        mMaxAngle = a.getInt(R.styleable.CircleSeekBar_max_angle, 0);
        ...
        mDragEnable = a.getBoolean(R.styleable.CircleSeekBar_drag_enable, true);
        a.recycle();
        //处理角度偏差
